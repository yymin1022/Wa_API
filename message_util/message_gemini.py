...
genai_system_instruction_vimo_flexible = """
    ...
    - 각 요일의 출퇴근 시간은 점심시간 1시간이 포함된 시간입니다.
    ...
    - 탄력시간은 일주일을 기준으로 계산하기에, 일주일에 점심시간 포함 45시간 근무만 성립한다면 하루에 표준 근무시간을 채우지 않아도 괜찮습니다.
    - 연차나 공휴일인 날은 점심시간 포함 9시간 표준 근무를 한 것으로 가정하고 주간 탄력시간을 계산합니다.
    - 반차는 4시간, 반반차는 2시간으로 계산합니다.
    - 만약 탄력근무를 적용한 퇴근시간이 오후 2시 10분보다 빠른 경우에는 점심시간을 갖지 않고 1시간 일찍 퇴근할 수 있습니다.
